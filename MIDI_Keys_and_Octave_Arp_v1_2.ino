 ...
 *   ..press arp hold button to clear thia.
 *   
 ...
 *   Code changes;
 *    
 *   Line 816 Added this to clear the hanging note
 *    
 *   STAT1 no renamed velPot
 *   STAT2 no renamed arpTempPot
 *   muted serial monitor
 *    
 *   v1.1
