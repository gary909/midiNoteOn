//Gary Edit: This version removes the stop arp button
//Gary Edit2: reassign pins for use on free slots on midi keyboard
// todo: add bypass mode?

#include <MIDI.h>

MIDI_CREATE_DEFAULT_INSTANCE(); // Added to orignal code

                    // FYI A6 & A7 are analog only on Nano :-)
#define STAT1    A6 //7 Velocity??
#define STAT2    A7 //6 Tempo??
